...
export const ROUTE_ACCESS: RouteAccess[] = [
  ...
  { path: "/login", roles: [], requiresAuth: false, description: "Login page" },
  {
    ...
    roles: [],
    requiresAuth: false,
    description: "Become reviewer page",
  },
  {
    path: "/become-reviewer-auth",
    roles: [],
    requiresAuth: false,
    description: "Reviewer auth page",
  },
  {
    path: "/r/[slug]",
    roles: [],
    requiresAuth: false,
    description: "Public reviewer profile",
  },
  ...
  },
  {
    ...
    roles: ["reviewer", "admin"],
    requiresAuth: true,
    description: "Edit reviewer profile",
  },
  {
  ...
  {
    path: "/creator/review/[id]",
    roles: ["reviewer", "admin"],
    requiresAuth: true,
    description: "Review specific resume",
  },
  {
    path: "/creator/analytics",
    roles: ["reviewer", "admin"],
    requiresAuth: true,
    description: "Reviewer analytics",
  },
...
export function canAccessRoute(userRole: UserRole, path: string): boolean {
  const route = ROUTE_ACCESS.find(
    (r) =>
      r.path === path ||
      (r.path.includes("[") &&
        path.match(new RegExp(r.path.replace(/\[.*?\]/g, "[^/]+"))))
  );
